...
public class Student
{
	...
	public void addCourse(Course c, Transcript.Semester semester, int year,
			Grade grade)
	{
	...
	public boolean changeGrade(Course c, Transcript.Semester semester, int year,
			Grade grade, Grade newGrade)
	{
